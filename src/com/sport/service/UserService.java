...
import com.sport.dao.UserMapper;
...
public class UserService {
	...
	public List<SysMenu> getMenu(int userId) {
		return userMapper.getMenuByRoleId(userId);  
	}
	...
	public List<User> searchUserByName(PageHelper page,String userName) {
		page.setStart((page.getPage()-1)*page.getRows());
		page.setEnd(page.getPage()*page.getRows());
		return userMapper.searchUserByName(page,userName);  
	}
