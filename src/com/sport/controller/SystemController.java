...
import com.sport.model.easyui.Tree;
import com.sport.service.UserService;
import com.sport.util.RequestUtil;
import com.sport.util.UserCookieUtil;
import com.sport.util.common.Const;
...
public class SystemController extends BaseController {
    ...
    public List<Tree> getMenu(HttpSession session){  
    	...
    	List<SysMenu> menuList = userService.getMenu(user.getRoleId());
