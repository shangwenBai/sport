...
<script type="text/javascript">
	...
	//快速查询
 	function searchUserQ(){
	 	var row = $('#datagrid').datagrid('getSelected');
	 	url = path+"/user/searchUser?userName="+$('#search_username').val();
	 	alert(url);
	 	$('#datagrid').datagrid({
				url: path+"/user/searchUserByName?userName="+$('#search_username').val()
		});
	...
	<div region="center" border="false" style="overflow: hidden;">
		...
		<div id="dlgsearch" class="easyui-dialog"
			...
			<form id="fmsearch" method="post" novalidate>
				...
				<div class="fitem">
					<label>身份证:</label> <input name="idcard" class="easyui-textbox" >
				</div>
				<div class="fitem">
					<label>性别:</label> 
		...
		<div id="dlg-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6"
				iconCls="icon-ok" onclick="moreSearch()" style="width:90px">查询</a> 
				<a href="javascript:void(0)" class="easyui-linkbutton"
